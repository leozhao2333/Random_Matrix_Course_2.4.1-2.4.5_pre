...
\begin{frame}{$2\times 2$ Real Symmetric Matrix}
    \begin{itemize}
        \item Consider a $2\times 2$ real symmetric matrix $M=\begin{bmatrix}a&b\\b&c\end{bmatrix}$ with distinct eigenvalues $\lambda_1\neq\lambda_2$. THen $M=U\begin{bmatrix}\lambda_1&0\\0&\lambda_2\end{bmatrix}*^T$, and without loss of generality we can assume $U=\begin{bmatrix} \cos\theta &-\sin\theta \\ \sin\theta & \cos\theta \end{bmatrix}$
    \end{itemize}
\end{frame}
