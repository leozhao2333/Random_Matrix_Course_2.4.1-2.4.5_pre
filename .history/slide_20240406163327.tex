    ...
    \begin{itemize}
        ...
        \item \begin{align*}
                  \begin{split}
                      ...
                      b & =\left(\lambda_1-\lambda_2\right)\cos\chi\sin\theta\cos\theta \\
                      c & =\left(\lambda_1+\lambda_2\right)\sin\chi\sin\theta\cos\theta \\
                      d & =\lambda_{1}\sin^{2}\theta+\lambda_{2}\cos^{2}\theta
                  \end{split}
              \end{align*}
        \item
              \begin{align*}
                  \frac{\partial(a,b,c,d)}{\partial(\lambda_1,\lambda_2,\theta,\chi)}=\begin{bmatrix}\cos^2\theta & \sin^2\theta & -2(\lambda_1-\lambda_2)\cos\theta\sin\theta & 0\\ \cos\theta\sin\theta & -\cos\theta\sin\theta & (\lambda_1-\lambda_2)(\cos^2\theta-\sin^2\theta) & 0\\ \sin^2\theta & \cos^2\theta & 2(\lambda_1-\lambda_2)\cos\theta\sin\theta & 0\\ 0 & 0 & 0 & 0\end{bmatrix}.
              \end{align*}
    \end{itemize}
\end{frame}
...
\begin{frame}{应用领域}
    ...
    \begin{itemize}
        ...
        \item 一篇题���"Cybersecurity Vital Signs: The Role of Anomaly Detection on Insider Threat Triage"的研究��由Karla Clarke和Yair Levy�������2019年�������，探讨�������异常检测在�������威胁������中�����������������要作用\footfullcite{Clarke2019CybersecurityVS}。
