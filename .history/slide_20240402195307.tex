...
\begin{frame}{四元数的矩阵表示}
    \begin{itemize}
        \item 一个四元数可以用$2\times 2$矩阵表示，类似地，二级四元数可以用$4\times 4$矩阵表示，其四个基$1,\mathbf{i_2},\mathbf{j_2},\mathbf{k_2}$表示成
              \begin{align*}
                  1=\begin{bmatrix} I_2 & 0\\ 0 & I_2\end{bmatrix},\quad\mathbf{i}=\begin{bmatrix} iI_2 & 0\\ 0 & -iI_2\end{bmatrix},\quad\mathbf{j}=\begin{bmatrix} 0 & 1\\ -1 & 0\end{bmatrix},\quad\mathbf{k}=\begin{bmatrix} 0 & i\\ i & 0\end{bmatrix}
              \end{align*}
    \end{itemize}
\end{frame}
