...
\begin{frame}{Spectral Theorem}
    \begin{itemize}
        ...
        \item Three ensembles:
            \begin{itemize}
                \small
                \item \textbf{orthogonal ensemble}: the set of $n \times n$ random \textcolor{red}{real} \tetbf{symmetric} matrices
                \item \textbf{unitary ensemble}: the set of $n \times n$ random \textcolor{red}{complex} \textbf{Hermitian} matrices
                \item \textnf{symplectic ensemble}: the set of $n \times n$ random \textcolor{red}{quaternion} \textbf{self-dual Hermitian} matrices
            \end{itemize}
    \end{itemize}
\end{frame}
