...
\begin{frame}{$2\times 2$ Hermitian Matrix}
    \begin{itemize}
        ...
        \item The determinant can be:
              ...
              where
              \begin{align*}
                  \left.f_2(\theta,\chi)=\left|\det\begin{bmatrix}\cos^2\theta & \sin^2\theta & -\sin2\theta & 0\\ \cos\theta\sin\theta\cos\chi & -\cos\theta\sin\theta\cos\chi & \cos2\theta\cos\chi & -\frac{1}{2}\sin2\theta\sin\chi \\ -\cos\theta\sin\theta\sin\chi & \cos\theta\sin\theta\sin\chi & -\cos2\theta\sin\chi & -\frac{1}{2}\sin2\theta\cos\chi \\ \sin^2\theta & \cos^2\theta & \sin2\theta & 0\end{bmatrix}\right.\right|=1>0
              \end{align*}
    \end{itemize}
\end{frame}
