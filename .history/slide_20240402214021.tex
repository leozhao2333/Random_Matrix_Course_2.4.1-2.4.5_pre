...
\begin{frame}{Gaussian Symplectic Ensemble(GSE)}
    \begin{itemize}
        ...
        \item Example: $\begin{bmatrix}
                      \begin{bmatrix}a_{11}&0\\0&a_{11}\end{bmatrix} & \begin{bmatrix}a_{11}&0\\0&a_{11}\end{bmatrix} \\
                      \begin{bmatrix}a_{11}&0\\0&a_{11}\end{bmatrix} & \begin{bmatrix}a_{44}&0\\0&a_{44}\end{bmatrix}
                  \end{bmatrix}$
