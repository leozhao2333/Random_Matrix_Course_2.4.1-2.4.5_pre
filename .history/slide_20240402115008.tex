...
\begin{frame}{应用领域}
    ...
    \begin{itemize}
        ...
        \item 一项名为"Medical Healthcare System Based on Wireless Body Area Networks: The Importance of Anomaly Detection"的��究，由Hayder Hassaballah、Rashid Fayadh和Bushra AlHayali于2020年提出���旨在探讨在医疗WBSN系统中����用�����检测的现代框架\footfullcite{Medical_Healthcare}�������
    \end{itemize}
\end{frame}
