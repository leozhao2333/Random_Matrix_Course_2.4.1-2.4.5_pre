...
\begin{frame}{$2\times 2$ Real Symmetric Matrix}
    \begin{itemize}
        ...
        \item
              ...
              \end{align*}
              where \begin{align*}
                  \left.f_1(\theta)=\left|\det\begin{pmatrix}\cos^2\theta&\sin^2\theta&-2\sin2\theta\\\frac12\sin2\theta&-\frac12\sin2\theta&\cos2\theta\\\sin^2\theta&\cos^2\theta&\sin2\theta\end{pmatrix}\right.\right|=1>0
              \end{align*}
    \end{itemize}
\end{frame}
