...
\begin{frame}{$2\times 2$ Hermitian Matrix}
    \begin{itemize}
        ...
        \item The determinant can be:
              ...
              where
              \begin{align*}
                  \left.f_2(\theta,\chi)=\left|\det\begin{bmatrix}\cos^2\theta&\sin^2\theta&-2\sin2\theta\\\frac12\sin2\theta&-\frac12\sin2\theta&\cos2\theta\\\sin^2\theta&\cos^2\theta&\sin2\theta\end{bmatrix}\right.\right|=1>0
              \end{align*}
    \end{itemize}
\end{frame}
