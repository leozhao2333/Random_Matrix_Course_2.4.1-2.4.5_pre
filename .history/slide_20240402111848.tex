...
\begin{frame}{应用领域}
    ...
    \begin{itemize}
        ...
        \item 一篇题���"Cybersecurity Vital Signs: The Role of Anomaly Detection on Insider Threat Triage"的研究，由Karla Clarke和Yair Levy于2019年提出，探讨了异常检测在��部威胁检��中的重要作用\footfullcite{Clarke2019CybersecurityVS}。
