...
\begin{frame}{$2\times 2$ Real Symmetric Matrix}
    \begin{itemize}
        ...
        \item
              \begin{align*}
                  \frac{\partial(a,b,c)}{\partial(\lambda_1,\lambda_2,\theta)}=\begin{pmatrix}\cos^2\theta&\sin^2\theta&-2(\lambda_1-\lambda_2)\cos\theta\sin\theta\\\cos\theta\sin\theta&-\cos\theta\sin\theta&(\lambda_1-\lambda_2)(\cos^2\theta-\sin^2\theta)\\\sin^2\theta&\cos^2\theta&2(\lambda_1-\lambda_2)\cos\theta\sin\theta\end{pmatrix}.
              \end{align*}
    \end{itemize}
\end{frame}
...
\begin{frame}{应用领域}
    ...
    \begin{itemize}
        ...
        \item 一篇题���"Cybersecurity Vital Signs: The Role of Anomaly Detection on Insider Threat Triage"的研究��由Karla Clarke和Yair Levy�����2019年������，探讨���异常检测在��部威胁检��中����������要作用\footfullcite{Clarke2019CybersecurityVS}。
        \item 一项名为"Medical Healthcare System Based on Wireless Body Area Networks: The Importance of Anomaly Detection"������，由Hayder Hassaballah、Rashid Fayadh和Bushra AlHayali于2020年提出������在�����在医疗WBSN���统中�������用�����检测的现代��架\footfullcite{Medical_Healthcare}�������
    \end{itemize}
\end{frame}
