...
\begin{frame}{应用领域}
    ...
    \begin{itemize}
        ...
        \item 一项名为"Medical Healthcare System Based on Wireless Body Area Networks: The Importance of Anomaly Detection"������，由Hayder Hassaballah、Rashid Fayadh和Bushra AlHayali于2020年提出���旨在�����在医疗WBSN���统中������用�����检测的现代��架\footfullcite{Medical_Healthcare}�������
    \end{itemize}
\end{frame}
