...
\begin{frame}{$2\times 2$ Hermitian Matrix}
    \begin{itemize}
        ...
        \item
              \begin{align*}
                  \frac{\partial(a,b,c,d)}{\partial(\lambda_1,\lambda_2,\theta,\chi)}=\begin{bmatrix}\cos^2\theta & \sin^2\theta & -2(\lambda_1-\lambda_2)\cos\theta\sin\theta\\ \cos\theta\sin\theta & -\cos\theta\sin\theta & (\lambda_1-\lambda_2)(\cos^2\theta-\sin^2\theta)\\ \sin^2\theta & \cos^2\theta & 2(\lambda_1-\lambda_2)\cos\theta\sin\theta\end{bmatrix}.
              \end{align*}
    \end{itemize}
\end{frame}
