...
\begin{frame}{Spectral Theorem}
    \begin{itemize}
        \item Exery \textcolor{red}{real symmetric} matrix has the factorization $S=Q\Lambda Q^T$ with \textcolor{red}{real} eigenvalues in $\Lambda$ and orthonormal eigenvectors in the columns of $Q$ can be diagonalized:
              \begin{align*}
