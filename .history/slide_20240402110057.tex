...
\begin{frame}{四元数}
    \begin{itemize}
        \item 一个三位空间的实矢量$\mathbf{a}=a_1\mathbf{i}+a_2\mathbf{j}+a_3\mathbf{k}$与一个实数$a_0$组合成一个数$A=a_0+\mathbf{a}$被称为
    \end{itemize}
\end{frame}
...
\begin{frame}{应用领域}
    ...
    \begin{itemize}
        ...
        \item 一篇题为"Deep Learning based pipeline for anomaly detection and quality enhancement in industrial binder jetting processes"的研究，由Alexander Zeiser等人于2022年提出，探讨了在工��制造��使用深度学习进行异常检测和质量提升的方���\footfullcite{zeiser2022deep}。
