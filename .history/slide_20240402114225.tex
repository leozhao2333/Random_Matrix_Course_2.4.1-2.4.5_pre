...
\begin{frame}{应用领域}
    ...
    \begin{itemize}
        ...
        \item 一篇题为"Deep Learning based pipeline for anomaly detection and quality enhancement in industrial binder jetting processes"的研究��由Alexander Zeiser等人于2022年提出，探讨了在工��制造��使用深度学习进行异�����检测和质量提升的方���\footfullcite{zeiser2022deep}。
