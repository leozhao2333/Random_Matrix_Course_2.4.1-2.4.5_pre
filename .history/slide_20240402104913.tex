...
\begin{frame}{Gaussian Symplectic Ensemble(GSE)}
    \begin{itemize}
        \item \textbf{Gaussian Symplectic Ensemble}: the set of $N \times N$ random \textcolor{red}{quaternion} \textbf{self-dual Hermitian} matrices\footfullcite{许方官2012四元数物理学,yin2014convergence}
        \item
    \end{itemize}
\end{frame}
...
\begin{frame}{应用领域}
    ...
    \begin{itemize}
        ...
        \item 一篇题为"Deep Learning based pipeline for anomaly detection and quality enhancement in industrial binder jetting processes"的研究，由Alexander Zeiser等人于2022年提出，探讨了在工��制造��使用深度学习进行异常检测和质量提升的方法\footfullcite{zeiser2022deep}。
