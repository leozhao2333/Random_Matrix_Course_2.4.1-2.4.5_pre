    ...
    \begin{itemize}
        ...
        \item Consider a $4\times 4$ Hermitian self-dual matrix
              $M=\begin{bmatrix}
                      \begin{bmatrix}a_{11}&0\\0&a_{11}\end{bmatrix}                                            & \begin{bmatrix}a_{12}+b_{12}i&c_{12}+d_{12}i\\-c_{12}+d_{12}i&a_{12}-b_{12}i\end{bmatrix} \\
                      \begin{bmatrix}a_{12}-b_{12}i&-c_{12}-d_{12}i\\c_{12}-d_{12}i&a_{12}+b_{12}i\end{bmatrix} & \begin{bmatrix}a_{44}&0\\0&a_{44}\end{bmatrix}
                  \end{bmatrix}$. Then $M=U\begin{bmatrix}\mu_1&0&0&0\\0&\lambda_2\end{bmatrix}U^*$, and without loss of generality we can assume $U=\begin{bmatrix}\cos\theta & -\left(\cos\chi-i\sin\chi\right)\sin\theta\\ \left(\cos\chi+i\sin\chi\right)\sin\theta & \cos\theta\end{bmatrix}$ for some $0\leq\theta\leq\frac12\pi$ and $\quad0\leq\chi<2\pi$.
    \end{itemize}
\end{frame}
