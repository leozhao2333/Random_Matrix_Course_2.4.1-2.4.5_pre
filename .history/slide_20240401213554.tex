...
\begin{frame}{Spectral Theorem}
    \begin{itemize}
        ...
        \item Three ensembles:
            \begin{itemize}
                \item \textbf{orthogonal ensemble}: the set of $n \times n$ random \blue{real} \tetbf{symmetric} matrices
                \item \textbf{unitary ensemble}: the set of $n \times n$ random \blue{complex} \textbf{Hermitian} matrices
                \item \textnf{symplectic ensemble}: the set of $n \times n$ random \blue{quaternion} \textbf{self-dual Hermitian} matrices
            \end{itemize}
    \end{itemize}
\end{frame}
