...
\begin{frame}{四元数的矩阵表示}
    \begin{itemize}
        \item \textbf{一级四元数与$2\times 2$矩阵}: 把四元数的四个基$1,\mathbf{i},\mathbf{j},\mathbf{k}$分别用四个$2\times 2$矩阵表示成
              ...
              \begin{align*}
                  A=a_0+\mathbf{a}=\begin{bmatrix} a_0+ia_1 & a_2+ia_3\\ -a_2+ia_3 & a_0-ia_1\end{bmatrix}
              \end{align*}
    \end{itemize}
\end{frame}
...
\begin{frame}{应用领域}
    ...
    \begin{itemize}
        ...
        \item 一篇题���"Cybersecurity Vital Signs: The Role of Anomaly Detection on Insider Threat Triage"的研究��由Karla Clarke和Yair Levy�����2019年提��，探讨���异常检测在��部威胁检��中的���要作用\footfullcite{Clarke2019CybersecurityVS}。
