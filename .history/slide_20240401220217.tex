    ...
    \begin{itemize}
        ...
        \item Three ensembles:
              \begin{itemize}
                  ...
                  \item \textbf{unitary ensemble}: the set of $n \times n$ random complex \textbf{Hermitian} matrices
                  \item \textbf{symplectic ensemble}: the set of $n \times n$ random quaternion \textbf{self-dual Hermitian} matrices
              \end{itemize}
    \end{itemize}
\end{frame}
