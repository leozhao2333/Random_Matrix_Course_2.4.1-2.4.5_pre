...
\begin{frame}{Spectral Theorem}
    \begin{itemize}
        ...
        \item Three ensembles:
              \begin{itemize}
                  \small
                  \item \textbf{orthogonal ensemble}: the set of $N \times N$ random $\color{red}\text{real}$ \textbf{symmetric} matrices
                  \item \textbf{unitary ensemble}: the set of $N \times N$ random $\color{red}\text{complex}$ \textbf{Hermitian} matrices
                  \item \textbf{symplectic ensemble}: the set of $N \times N$ random $\color{red}\text{quaternion}$ \textbf{self-dual Hermitian} matrices
              \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}{Spectral Theorem}
    \begin{itemize}
        \item Exery $\color{red}\text{real symmetric}$ $S$ can be diagonalized: $S=Q\Lambda Q^{-1} = Q\Lambda Q^T$
    \end{itemize}
\end{frame}
