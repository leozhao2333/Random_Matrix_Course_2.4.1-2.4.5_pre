...
\begin{frame}{Spectral Theorem}
    \begin{itemize}
        ...
        \item Three ensembles:
            \begin{itemize}
                \small
                \item \textbf{orthogonal ensemble}: the set of $n \times n$ random $\color{red}{complex}$ \tetbf{symmetric} matrices
                \item \textbf{unitary ensemble}: the set of $n \times n$ random $\color{red}{complex}$ \textbf{Hermitian} matrices
                \item \textnf{symplectic ensemble}: the set of $n \times n$ random $\color{red}{quaternion}$ \textbf{self-dual Hermitian} matrices
            \end{itemize}
    \end{itemize}
\end{frame}
