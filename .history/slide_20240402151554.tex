...
\begin{frame}{四元数的矩阵表示}
    \begin{itemize}
        ...
        \item \textbf{四元共轭}:
              \begin{align*}
                  \overline{A}=a_0-a_1\mathbf{i}-a_2\mathbf{j}-a_3\mathbf{k}=\begin{bmatrix} a_0-ia_1 & -a_2-ia_3\\ a_2-ia_3 & a_0+ia_1\end{bmatrix}=\begin{bmatrix} \bar{\alpha} & -\bar{\beta}\\ \bar{\beta} & \alpha\end{bmatrix}
              \end{align*}
        \item \textbf{反共轭}:
              \begin{align*}
                  A^c=a_0^*+a_1^*\mathbf{i}+a_2^*\mathbf{j}+a_3^*\mathbf{k}=\begin{bmatrix} a_0^*+ia_1^* & a_2^*+ia_3^*\\ -a_2^*+ia_3^* & a_0^*-ia_1^*\end{bmatrix}
              \end{align*}
    \end{itemize}
\end{frame}
